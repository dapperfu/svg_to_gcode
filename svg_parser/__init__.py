...
from svg_to_gcode.svg_parser._parser_methods import parse_file
from svg_to_gcode.svg_parser._parser_methods import parse_root
from svg_to_gcode.svg_parser._parser_methods import parse_string
